...
// Visits Summary
    function loadVisitsSummaryPanel() {
      ...
      $src = osc_href_link_admin(FILENAME_JSON, 'module=reports_web&action=draw_visits_summary_sparkline&start_date=' . $start_date . '&end_date=' . $end_date . '&period=' . $period . '&token=' . $_SESSION['token']);
  ...
  // Traffic Source Summary    
    function loadTrafficSourceSummaryPanel() {
      ...
      $src = osc_href_link_admin(FILENAME_JSON, 'module=reports_web&action=draw_traffic_source_summary_sparkline&start_date=' . $start_date . '&end_date=' . $end_date . '&period=' . $period . '&token=' . $_SESSION['token']);
