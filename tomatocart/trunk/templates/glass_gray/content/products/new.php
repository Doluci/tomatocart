  ...
  <div class="content">
    ...
    ?>
        ...
        <td align="right" valign="middle">
          <?php 
            echo toc_draw_link_button(osc_href_link(FILENAME_PRODUCTS, $Qproducts->value('products_id') . '&action=cart_add'), $osC_Language->get('button_add_to_cart')toc_draw_link_button(osc_href_link(FILENAME_INFO), $osC_Language->get('button_continue')), 'ajaxAddToCart', 'id="ac_productsnew_' . $Qproducts->value('products_id') . '"');
          ?>
        </td>
      </tr>
